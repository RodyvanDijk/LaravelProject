            ...
            <tr class="text-gray-700">
                ...
                <td class="px-4 py-3 text-sm">
                    <form action="{{route('cart.store')}}" method="POST" class="flex flex-row">
                        ...
                        <input type="number" value="1" name="quantity" max="9" class="text-sm sm:text-base px-2 pr-2 rounded-lg border border-gray-400 py-1 focus:outline-none focus:border-blue-400">
